...
本教程的目标是**理解原理、学会应用**，不是培养研究者。

作者本人从事云计算产品工作，学习 LLM 的目的是理解它的能力边界，从而更好地向客户推荐和落地 AI 方案。教程内容结合网上公开资料，由 LLM 辅助生成并经人工审校整理，侧重于用通俗的语言把概念讲清楚、用可运行的代码把流程跑通。

如果你的目标是深入研究模型架构、训练方法或前沿算法，建议直接阅读原始论文和学术课程——那不是本教程覆盖的范围。
